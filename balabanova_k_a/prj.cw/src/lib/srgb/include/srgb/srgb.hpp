...
/**
 * @file srgb.hpp
 * @brief Данный фаил был взят с https://github.com/PetterS/opencv_srgb_gamma/blob/master/srgb.h
 * */

/**
 * @namespace vision взято с https://github.com/PetterS/opencv_srgb_gamma/blob/master/srgb.h
 * @brief пространство имен, функции которого позволяют перейти от [0, 255] к [0,1] координатам в 
*/
namespace vision {
